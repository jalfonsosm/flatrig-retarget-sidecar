"""Clone and bootstrap a local Motion2Motion checkout for flatRig."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Bootstrap Motion2Motion for flatRig.")
    parser.add_argument(
        "--checkout",
    ...
    print("Notes:")
    print(
        "- The default path now reuses the sidecar root .venv so FlatRig Python and C++ share one Torch runtime."
    )
    print(
